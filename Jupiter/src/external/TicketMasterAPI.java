...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "TJn0QGMuA1eAobytyqa1pXclMGnLuobV";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			//Open a HTTP connection between JAVA application and TicketMaster
			...
			//response code could be returned directly
